...
CREATE (ucla_h2:Host { id: "ucla_h2", type: "XDS SIGMA7" })
...
CREATE (sri_h2:Host { id: "sri_h2", type: "XDS-940" })
...
CREATE (mit_h3:Host { id: "mit_h3", type: "GE-645" })
...
CREATE (bbn_h1:Host { id: "bbn_h1", type: "DDP-516" })
...
CREATE (rand:Node { id: "rand", type: "IMP", site: "RAND" })
...
CREATE (sdc_h2:Host { id: "sdc_h2", type: "360/67" })
